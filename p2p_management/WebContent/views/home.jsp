...
<body>
			...
			<div class="ui horizontal list">
				<div class="item">
					<a href="javascript:;">${user.username} </a> <a href="javascript:;"
						onclick="logout()"><i class="power icon"></i></a>
				</div>
	...
	<div class="ui grid">
				...
				<div class="ui grid">
					<div class="wide  column">
						<div class="ui tab segment active" data-tab="first">
							...
							<div class="btns">
								<div class="settings">
									<div id="addButton" class="ui green fade button" tabindex="0">
										<div class="visible content">新增产品</div>
									</div>
								</div>
								<div class="search">
							...
							<div class="items">
								<table class="ui sortable celled table">
									...
									<tfoot>
										<tr>
											<th colspan="2"><span>共有<strong id="totalInfo"></strong>条数据，当前是第<strong
													id="pageInfo"></strong>页
											</span></th>
											<th colspan="9">
												<div id="paginationDiv" class="ui right floated pagination menu">
		...
		<div class="ui small modal">
			...
			<div class="content">
				<form id="prodForm" class="ui form">
					<div class="field">
						<label>产品编号</label> <input type="text" name="proNum"
							placeholder="产品编号">
					</div>
					<div class="field">
						<label>产品名称</label> <input type="text" name="proName"
							placeholder="产品名称">
					</div><div class="field">
						<label>期限</label> <input type="text" name="proLimit"
							placeholder="期限">
					</div><div class="field">
						<label>年化利率</label> <input type="text" name="annualized"
							placeholder="年化利率">
					</div>
					<button id="submitButton" class="ui button" type="button">提交</button>
				</form>
			</div>
		</div>
